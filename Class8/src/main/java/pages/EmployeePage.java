...
public class EmployeePage extends BasePage {
    ...
    public void addEmployee(Employee employee){
        webDriver.findElement(nameInput).sendKeys(employee.getName());
        webDriver.findElement(cityInput).sendKeys(employee.getCity());
        webDriver.findElement(stateInput).sendKeys(employee.getState());
        webDriver.findElement(postcodeInput).sendKeys(employee.getPostcode());
        webDriver.findElement(emailInput).sendKeys(employee.getEmail());
        webDriver.findElement(addressInput).sendKeys(employee.getAddress());
        webDriver.findElement(phoneInput).sendKeys(employee.getPhone());
